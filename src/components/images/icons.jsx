...
export const HomeIcon = () =>{
    return <svg aria-label="Главная страница" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                viewBox="0 0 24 24" width="24">
        <path
...
export const DirectIcon = () =>{
    return <svg aria-label="Messenger" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                viewBox="0 0 24 24" width="24">
        <path
...
export const NavigationIcon = () =>{
    return <svg aria-label="Найти людей" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                viewBox="0 0 24 24" width="24">
...
export const FavoriteIcon = () =>{
    return <svg aria-label="Что нового" className="_ab6-" color="#262626" fill="#262626" height="24" role="img"
                viewBox="0 0 24 24" width="24">
        <path
